...
of the frozen tensors---are being made available in the code repository listed
below; the raw CERT data must be obtained separately from the original source
under its own licence.

\section*{Code Availability}
The repository at
\url{https://github.com/alriyami7777-alt/teacher-anchored-insider-threat-detection}
provides the reproducibility protocols and the fixed random seeds (42, 52, and
62) used in this study. The paper-facing implementation package---covering data
preparation, teacher-anchored training, evaluation, and explanation
analyses---together with the validation-selected thresholds,
sequence-construction configuration, dataset manifests, and frozen-tensor
hashes, is being prepared for public release in the same repository. CERT data,
user-level records, tensors, prediction arrays, and model checkpoints are not
redistributed.
