...
previously trained model \cite{Furlanello2018BornAgain}. Distillation has
also been used to transfer a neural network into an interpretable soft
decision tree \cite{FrosstHinton2017SoftTree}; the present teacher-anchored
procedure instead retains a single same-architecture model and can be viewed
as a consistency-regularisation instantiation applied to the routing of a
differentiable oblivious-tree head, rather than distilling behaviour into a
separate tree.
