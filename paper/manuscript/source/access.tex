...
% ORCID link, self-contained (no extra package; uses graphicx + hyperref).
% If orcid.png is in the project it shows the ORCID logo; otherwise it
% falls back to a small linked "ORCID" tag. Either way it compiles.
\newcommand{\orcidlink}[1]{%
  \href{https://orcid.org/#1}{%
    \IfFileExists{orcid.png}%
      {\raisebox{-0.15ex}{\includegraphics[height=1em]{orcid.png}}}%
      {\textsuperscript{\scriptsize ORCID}}}}
% -----------------------------------------------------------------------------
% Document
% -----------------------------------------------------------------------------
\begin{document}
...
\author{
\uppercase{Qasim Mohamed Muhanna Alriyami}\authorrefmark{1}~\orcidlink{0009-0007-8081-9997},
AND
\uppercase{Mohd Murtadha Bin Mohamad}\authorrefmark{1}~\orcidlink{0000-0002-1478-0138},
...
statistically supported PR-AUC advantage over the flattened Random Forest
reference (RF-260). The ODST head is
