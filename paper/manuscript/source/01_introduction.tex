...
\begin{enumerate}
    ...
    and which components---teacher initialisation, logit anchoring, or route
    anchoring---account for that stability?
...
\begin{itemize}
    ...
    evaluated across three predefined CERT r5.2 validation seeds and
    decomposed by a loss-component ablation, showing that teacher
    initialisation supplies the baseline routing stability while the
    route-consistency term further tightens routing and tree-contribution
    fidelity, with predictive non-degradation preserved throughout
    end-to-end student optimisation.
