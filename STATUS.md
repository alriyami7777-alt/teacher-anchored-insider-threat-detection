...
## Objective 1 — Time-aware preprocessing
...
- CERT r6.2 model-free warm-up and metadata audit through Stage 1F.

### Planned

- Full CERT r6.2 preprocessing and model-ready sequence generation after the preregistered readiness stage.

## Objective 2 — Unified sequence–ensemble modelling
...
- Same-information attention–linear and ODST comparison.
...
- ODST accounted for approximately 72–73% of device-resident inference time in the component audit.
...
## Objective 3 — Explanation and robustness
